      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            <a 
              href="#newsletters" 
              className="bg-[#f79630] text-white px-4 py-2 rounded-lg font-medium hover:bg-[#e6861c] transition-colors duration-200"
            >
              NEWSLETTERS
            </a>
          </nav>
        ...
        {isMenuOpen && (
          <div className="lg:hidden bg-white border-t border-gray-200">
            <div className="py-4 space-y-2">
              ...
              <a 
                href="#newsletters" 
                className="block mx-4 mt-4 bg-[#f79630] text-white px-4 py-2 rounded-lg font-medium text-center hover:bg-[#e6861c] transition-colors duration-200"
                onClick={() => setIsMenuOpen(false)}
              >
                NEWSLETTERS
              </a>
