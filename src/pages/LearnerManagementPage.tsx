      ...
      <section id='bbbee-booking' className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <p className="text-center text-gray-600 mb-8 max-w-2xl mx-auto">
            Get in touch with us today to chat about how we can assist your business. Call us at <a href="tel:+27 001 2309" className="text-[#2d2e83] font-semibold hover:underline">+27 001 2309</a> or submit your info in the enquiry form below.
          </p>
